...
public class CartoonState extends GameState {
	...
	public CartoonState(GameStateManager gsm) {
		super(gsm);
		init();
	}
	...
	public void init() {
		...
		tileMap.loadTiles("/Tilesets/cartoontileset.gif");
		tileMap.loadMap("/Maps/cartoon.map");
