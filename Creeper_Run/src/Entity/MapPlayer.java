...
public class MapPlayer extends MapObject {
	...
	public MapPlayer(TileMap tm) {
		...
		*/
		...
		setAnimation(IDLE);
		/*
		JukeBox.load("/SFX/MapPlayerjump.mp3", "MapPlayerjump");
		JukeBox.load("/SFX/MapPlayerlands.mp3", "MapPlayerlands");
		JukeBox.load("/SFX/MapPlayerattack.mp3", "MapPlayerattack");
		JukeBox.load("/SFX/MapPlayerhit.mp3", "MapPlayerhit");
		JukeBox.load("/SFX/MapPlayercharge.mp3", "MapPlayercharge");
		*/
	}
